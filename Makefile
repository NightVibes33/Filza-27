...
before-FilzaApplySandboxExt-all::
	...
	@test -f "$(THREEONE_ROOT)/Sources/ContentView.swift" || (echo "Missing complete 3105 root navigation" >&2; exit 1)
	...
	@test -f "$(THREEONE_ROOT)/Sources/SettingsView.swift" || (echo "Missing 3105 Settings" >&2; exit 1)
