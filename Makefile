...
AIRCARD_SWIFT_FILES := $(AIRCARD_IOS)/AppViewModel.swift $(AIRCARD_IOS)/ContentView.swift $(AIRCARD_IOS)/Models.swift $(AIRCARD_IOS)/NetworkStatus.swift $(AIRCARD_IOS)/PairingController.swift $(AIRCARD_IOS)/Utilities.swift
